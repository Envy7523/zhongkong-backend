...
function createTemplate(sourceType) {
  const headers = sourceType === 'platform'
    ...
    : ['日期', '门店ID', '门店名称', '扫码支付', '现金', '小程序储值消费', '其他线下', '美团团购', '抖音团购', '美团外卖', '淘宝闪购', '京东外卖', '订单数'];
...
module.exports = { importWorkbook, getOverview, getScopedOverview, createTemplate, CHANNELS, periodExpr };
