    ...
    <el-dialog v-model="dialogVisible" title="发起协同事项" width="min(640px, calc(100vw - 32px))" :close-on-click-modal="false" @closed="resetForm">
      <el-form ref="formRef" :model="form" :rules="rules" label-position="top">
        ...
        <div class="form-dates">
          <el-form-item label="计划开始" prop="start_time"><el-date-picker v-model="form.start_time" type="date" value-format="YYYY-MM-DD" placeholder="可选" /></el-form-item>
          <el-form-item label="截止日期" prop="deadline"><el-date-picker v-model="form.deadline" type="date" value-format="YYYY-MM-DD" placeholder="可选" /></el-form-item>
        </div>
