<template>
  ...
  <div class="dash-stat-grid">
    <div class="dash-stat-card">
      <div class="dash-stat-icon" style="background:#e8f8e8;"><el-icon size="22"><User /></el-icon></div>
      <div class="dash-stat-body">
        <div class="dash-stat-value success">{{ stats.total ?? '—' }}</div>
        <div class="dash-stat-label">店员总数</div>
      </div>
    </div>
    <div class="dash-stat-card">
      ...
      <div class="dash-stat-body">
        ...
        <div class="dash-stat-label">在职店员</div>
      </div>
    </div>
    <div class="dash-stat-card">
      ...
      <div class="dash-stat-body">
        ...
        <div class="dash-stat-label">离职店员</div>
      </div>
    </div>
  </div>
  ...
  <div class="card-compact">
    <div class="card-header">🔍 搜索店员</div>
  ...
  <!-- 表格 -->
  <div class="card-compact">
    <div class="card-header">🧑‍🍳 店员列表（共 {{ total }} 人）</div>
  ...
  <!-- 编辑弹窗 -->
  <el-dialog v-model="editVisible" :title="'编辑店员 — ' + editForm.name" width="600px">
    <el-form label-width="100px">
      ...
      <el-row :gutter="12">
        ...
        <el-col :span="12"><el-form-item label="职位"><el-input v-model="editForm.position" /></el-form-item></el-col>
      </el-row>
      <el-row :gutter="12">
        <el-col :span="12">
        ...
        <el-col :span="12"><el-form-item label="入职日期"><el-input v-model="editForm.entry_date" placeholder="YYYY-MM-DD" /></el-form-item></el-col>
      </el-row>
...
async function loadData() {
  loading.value = true
  try {
    const params = { page: page.value, page_size: pageSize.value, role: '店员' }
...
async function loadStats() {
  try {
    const data = await getStaffStats({ role: '店员' })
